...
void AccountSettings::Init()
{
    ...
    ptr = str.GetBuffer(255);
    GetPrivateProfileString(section, _T("EM"), _T("1"), ptr, 256, iniFile);
    str.ReleaseBuffer();
    EM = _wtoi(str);
...
bool AccountSettings::AccountLoad(int id, Account *account)
{
    ...
    ptr = str.GetBuffer(255);
    GetPrivateProfileString(section, _T("AVPF"), NULL, ptr, 256, iniFile);
    str.ReleaseBuffer();
    account->avpf = str == _T("1") ? 1 : 0;
...
void AccountSettings::AccountSave(int id, Account *account)
{
    ...
    WritePrivateProfileString(section, _T("AVPF"), account->avpf ? _T("1") : _T("0"), iniFile);
...
// save user settings
    ...
    WritePrivateProfileString(section, _T("EM"), EM ? _T("1") : _T("0"), iniFile);
